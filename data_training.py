...
def train_on_single_gpu(dataset_id: str, trainer_name: str):
    modalities = ["2d", "3d_fullres", "3d_lowres", "3d_cascade_fullres"]
...
if __name__ == "__main__":
    trainer = "nnUNetTrainer_ULS_200_QuarterLR"
    source_root = "/home/jfigueira/aimi-project/data/fully_annotated_data"
    target_root = "/home/jfigueira/aimi-project/data/raw/"
    dataset_id = "001"

    #convert_to_mixed_dataset(source_root, target_root, split_percent=0.2)

    #print("Running nnUNetv2_plan_and_preprocess...")
    #subprocess.run(["nnUNetv2_plan_and_preprocess", "-d", dataset_id], check=True)
