...
def build_segformer3d_model(config=None):
    model = SegFormer3D(
        ...
        patch_stride_xy=config["model_parameters"]["patch_stride_xy"],
        patch_stride_z=config["model_parameters"]["patch_stride_z"],
...
class SegFormer3D(nn.Module):
    def __init__(
        ...
        patch_stride_xy: list = [4, 2, 2, 2],
        patch_stride_z: list = [4, 2, 2, 2],
        ...
        self.segformer_encoder = MixVisionTransformer(
            ...
            patch_stride_xy=patch_stride_xy,
            patch_stride_z=patch_stride_z,
...
class MixVisionTransformer(nn.Module):
    def __init__(
        ...
        self.embed_1 = PatchEmbedding(
            ...
            stride_z=patch_stride_z[0],
            stride_xy=patch_stride_xy[0],
        ...
        self.embed_2 = PatchEmbedding(
            ...
            stride_z=patch_stride_z[1],
            stride_xy=patch_stride_xy[1],
        ...
        self.embed_3 = PatchEmbedding(
            ...
            stride_z=patch_stride_z[2],
            stride_xy=patch_stride_xy[2],
        ...
        self.embed_4 = PatchEmbedding(
            ...
            stride_z=patch_stride_z[3],
            stride_xy=patch_stride_xy[3],
