...
#SBATCH --output=/home/jfigueira/aimi-project/logs/segformer_eval_dice_%j_%a.out
#SBATCH --error=/home/jfigueira/aimi-project/logs/segformer_eval_dice_%j_%a.err
