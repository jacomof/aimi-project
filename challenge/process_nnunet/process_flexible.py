...
class Uls23(SegmentationAlgorithm):
    ...
    def start_pipeline(self, model_dir, folds):
        """
        ...
        self.load_model(model_dir, folds)
    ...
    def load_model(self, model_dir, folds):
        ...
        self.predictor.initialize_from_trained_model_folder(
            f"/opt/ml/model/{model_dir}", # Path always relative to /opt/ml/model/
            use_folds=folds,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_dir', type=str, default='Dataset601_Full_128_64/nnUNetTrainer_ULS_500_QuarterLR__nnUNetPlans_shallow__3d_fullres_resenc', 
    ...
    folds = None if args.folds == 'None' else args.folds
    Uls23().start_pipeline(args.model_dir, folds)
